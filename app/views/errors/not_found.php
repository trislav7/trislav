...
// Заголовок 404 уже установлен в Router::handleNotFound()
...
<div class="container mx-auto max-w-4xl text-center">
    ...
    <?php elseif ($theme === 'media'): ?>
        ...
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Страница уплыла в медиапространство</h1>
            <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Возможно, эта страница была перемещена или удалена.
                Но не переживайте - у нас есть много других интересных медиарешений для вас!
            </p>
        </div>
    ...
    <?php else: ?>
        ...
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Проект не найден в нашем портфолио</h1>
            <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Возможно, этот проект还在 разработке или уже реализован под другим названием.
                Но у нас есть много других успешных кейсов!
            </p>
        </div>
    <?php endif; ?>
